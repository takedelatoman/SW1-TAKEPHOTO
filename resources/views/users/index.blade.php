                            ...
                            <div class="table-responsive p-0">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th
                                                class="align-middle text-center text-secondary text-xs font-weight-semibold opacity-7">
                                                Id</th>
                                            <th
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-sm font-weight-normal">{{ $user->id }}</span>
                                                </td>

                                                <td class="align-middle text-center">
                                                    <div>
                                                        <img src="{{ $user->photo1 }}"
                                                            class="avatar avatar-content rounded" style="object-fit: cover" alt="user1">
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center">
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="{{ route('users.show', $user->id) }}"
                                                        ...
                                                        data-bs-toggle="tooltip" data-bs-title="Ver Usuario">
