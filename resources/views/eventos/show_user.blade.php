                        ...
                        <form action="" method="POST" role="form text-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                            <input class="form-control" type="tel" placeholder="40770888444"
                                                id="number" name="phone" value="{{ $user->phone }}" disabled>
                                            @error('phone')
                                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                            <input class="form-control" type="text" placeholder="Tu Ubicación"
                                                id="name" name="location" value="{{ $user->location }}"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.about')border border-danger rounded-3 @enderror">
                                    <textarea class="form-control" id="about" rows="3" placeholder="Di algo sobre ti" name="about_me"
                                        disabled>{{ $user->about_me }}</textarea>
                                </div>
                            </div>
