                    ...
                    @foreach ($eventos as $evento)
                        @if ($evento->org_id == Auth::user()->id)
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <div class="card" id="eventoCard-{{ $evento->id }}">
                                    <div class="card-body p-3">
                                        <div class="d-flex flex-column">
                                            <div class="text-center">
                                                <div class="bg-gradient-dark card-image">
                                                    <div
                                                        class="position-relative d-flex align-items-center justify-content-center text-center">
                                                        <img class="img-fluid"
                                                            style="object-fit: cover; width: 100%; height: 100%; max-width: 300px; max-height: 150px;"
                                                            alt="rocket" src="{{ $evento->imagen }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <p class="mb-1 pt-2 text-bold" style="font-size: 14px;">
                                                    ...
                                                    {{ \Carbon\Carbon::parse($evento->hora)->format('H:i') }} horas
                                                </p>
                                                <h5 class="font-weight-bolder" style="font-size: 15px">
                                                    {{ $evento->nombre }}</h5>
                                                <b class="p-0 m-0">{{ $evento->tipo }}</b>
                                                <p class="mb-3" style="font-size: 12px;"> <b>Dirección: </b> <br>
                                                    {{ $evento->lugar }}, <br> {{ $evento->direccion }}</p>
                                                <a class="text-body text-sm font-weight-bolder mb-0 icon-move-right mt-1"
