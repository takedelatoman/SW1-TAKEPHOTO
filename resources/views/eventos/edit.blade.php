    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4 px-5">
            ...
            @if (Auth::user()->rol == 'Organizador')
                <div class="mt-4 mb-3" style="position: absolute; top: 50px; right: 10px;">
                        ...
                        <div class="card-body pt-4 p-3">
                            <form action="{{ route('eventos.update', $evento->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="evento-nombre" class="form-control-label">Nombre del
                                                Evento</label>
                                            <div class="@error('nombre')border border-danger rounded-3 @enderror">
                                                <input class="form-control" type="text"
                                                    placeholder="Nombre del evento" id="evento-nombre" name="nombre"
                                                    value="{{ $evento->nombre }}">
                                                @error('nombre')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="evento-fecha" class="form-control-label">Fecha del
                                                Evento</label>
                                            <div class="@error('fecha')border border-danger rounded-3 @enderror">
                                                <input class="form-control" type="date" id="evento-fecha"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="direccion"
                                                name="direccion" value="{{ $evento->direccion }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="position-relative">
                                            <img
                                                src="https://qrickit.com/api/qr.php?d={{ $url }}&qrsize=175&t=p&e=m">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit"
                                        class="btn bg-gradient-dark btn-md mt-0 mb-3">MODIFICAR</button>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="@error('fecha')border border-danger rounded-3 @enderror">
                                                <input class="form-control" type="date" id="evento-fecha"
                                                    name="fecha" value="{{ $evento->fecha }}" disabled>
                                                @error('fecha')
                                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                                @enderror
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="direccion"
                                                name="direccion" value="{{ $evento->direccion }}"
                                                placeholder="Dirección del evento" disabled>
                                            @error('direccion')
                                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                    ...
                    @foreach ($fotografias as $fotografia)
                        ...
                        @if ($fotografia->tipo == 'Privado')
                            @if ($fotografia->autor_id == Auth::user()->id)
                                <div class="col-md-4">
                                    <div style="position: relative; margin: 15px;">
                                        <img src="{{ $fotografia->foto_c }}" alt="Imagen de la carta"
                                            class="card-img"
                                            style="width: 100%; height: 300px; object-fit: cover; cursor: pointer"
                                            onclick="toggleCentered(event)">
