<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href="{{ route('dashboard') }}" >
            <i class="fas fa-camera text-white" style="font-size: 1.2rem; margin-right: 10px;"></i>
            <span class="font-weight-bold text-lg text-white">TakePhotos</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('users.index') ? 'active' : '' }}"
                    href="{{ route('users.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">

                        <i class="fa fa-users text-sm opacity-10" style="color: #ffff;"></i>
                    </div>
                    <span class="nav-link-text ms-1">Usuarios</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('eventos.index') ? 'active' : '' }}" href="{{ route('eventos.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">

                        <i class="fa-regular fa-calendar-check text-sm opacity-10" style="color: #ffff;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('user_evento.index') ? 'active' : '' }}" href="{{ route('user_evento.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">

                        <i class="fa-solid fa-list-check text-sm opacity-10" style="color: #ffff;"></i>
                    </div>
                    <span class="nav-link-text ms-1">Ofertas Trabajo</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('tarjetas.index') ? 'active' : '' }}" href="{{ route('tarjetas.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">

                        <i class="fa-regular fa-credit-card text-sm opacity-10" style="color: #ffff;"></i>
                    </div>
