        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item px-3 d-flex align-items-center">
                    <a href="{{ route('users.editMyProfile') }}" class="nav-link text-body p-0">
                ...
                <li class="nav-item ps-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0">
                        <img src="{{ Auth::user()->photo1 }}" class="avatar avatar-sm" alt="avatar" />
                    </a>
                </li>
            </ul>
            
            <div class="mb-0 font-weight-bold breadcrumb-text text-white" style="margin-left: 1rem">
