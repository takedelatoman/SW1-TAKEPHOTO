                    ...
                    <div class="card-body pt-4 p-3">
                        <form action="{{ route('tarjetas.store') }}" method="POST" role="form text-left">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tarjeta-name" class="form-control-label">Titular de la Tarjeta
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('tarjeta.numero')border border-danger rounded-3 @enderror">
                                            <input class="form-control" value="" type="text"
                                                placeholder="Número de Tarjeta" id="tarjeta-numero" name="numero"
                                                required>
                                            @error('numero')
                                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('tarjeta.cvc')border border-danger rounded-3 @enderror">
                                            <input class="form-control" value="" type="text" placeholder="CVV"
                                                id="tarjeta-cvc" name="cvc" maxlength="3" required>
                                            @error('cvc')
                                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tarjeta-fecha_v" class="form-control-label">Fecha de
                                            Vencimiento</label>
                                        <div class="@error('tarjeta.fecha_v')border border-danger rounded-3 @enderror">
                                            <input class="form-control" value="" type="date"
                                                placeholder="Fecha de Vencimiento" id="tarjeta-fecha_v" name="fecha_v"
                                                required>
                                            @error('fecha_v')
                                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
